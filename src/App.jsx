...
const BIO_CONTENT = {
  en: [
    "Jiaying He (*1997) is a Chinese composer based in Germany. Her musical aesthetics are grounded in the temporal displacement and repetition of identical material, creating deliberate perceptual disruptions and psychological time differences. By incorporating everyday sounds and instrumental noise, she understands sound as a carrier of experience, memory, and physical presence, and conceives of music as a space for active listening and open-ended relationships with the future.",
    "She is currently pursuing a Master’s degree in Composition at the Conservatoire de Paris (CNSMDP) with Frédéric Durieux, while simultaneously studying in the Master’s program in Musicology (Music Theory) with Elisabeth Schmierer, Hanna Fink, and Matthias Schlothfeldt at the Folkwang University of the Arts. She completed her Bachelor of Music in Integrative Composition at the Folkwang University of the Arts, where she studied with Günter Steinke.",
    "Jiaying He is currently working as a finalist on a new orchestral composition for the Orchestre Philharmonique de Radio France, which will be premiered in Paris on October 1, 2026. Her works have been performed by ensembles and orchestras such as the SWR Symphony Orchestra, the WDR Symphony Orchestra, and the Bergische Symphoniker, and have been presented in several European countries.",
    "She has received various awards and scholarships, including the Artist Scholarship of the State of North Rhine-Westphalia (2021/22), funding from the DAAD (PROMOS), and the Fondation Prix Monique Gabus Scholarship 2025 (France). She has participated in numerous international festivals, academies, and workshops, including the Impuls International Ensemble and Composers Academy, the Donaueschingen Music Days 2023, the Wittener Tage für neue Kammermusik 2025, and the NOW! Festival Essen 2025.",
    "In addition to her compositional work, Jiaying He also works as a music journalist. She writes concert reviews and reports on festivals for contemporary music, reflecting on current developments in new music as well as aesthetic and compositional questions. In 2026, she participated in the Journalists’ Forum of the ECLAT Festival for New Music and will report on the Wittener Tage für neue Kammermusik 2026 as a journalist for MusikTexte Online."
  ],
  de: [
    "Jiaying He (*1997) ist eine chinesische Komponistin und lebt in Deutschland. Ihre musikalische Ästhetik basiert auf der zeitlichen Verschiebung und Wiederholung identischen Materials, wodurch gezielt Wahrnehmungsirritationen und psychologische Zeitdifferenzen entstehen. Durch die Einbindung von Alltagsgeräuschen sowie instrumentalen Geräuschklängen versteht sie Klang als Träger von Erfahrung, Erinnerung und körperlicher Präsenz und begreift Musik als einen Raum aktiven Zuhörens und zukunftsoffener Beziehung.",
    "Derzeit studiert sie Komposition im Masterstudiengang am Conservatoire de Paris (CNSMDP) bei Frederic Durieux und ist parallel im Masterstudiengang Musikwissenschaft (Musiktheorie) bei Elisabeth Schmierer, Hanna Fink und Matthias Schlothfeldt an der Folkwang Universität der Künste eingeschrieben. Ihren Bachelor of Music in Integrative Komposition absolvierte sie an der Folkwang Universität der Künste bei Günter Steinke.",
    "Aktuell arbeitet Jiaying He als Finalistin an einer neuen Orchesterkomposition für das Orchestre Philharmonique de Radio France, die am 1. Oktober 2026 in Paris uraufgeführt wird. Ihre Werke wurden von Ensembles und Orchestern wie dem SWR-Symphonieorchester, dem WDR-Sinfonieorchester und den Bergischen Symphonikern aufgeführt und in mehreren europäischen Ländern präsentiert.",
    "Sie erhielt verschiedene Auszeichnungen und Stipendien, darunter das Künstlerstipendium des Landes Nordrhein-Westfalen (2021/22), Förderungen des DAAD (PROMOS) sowie das Stipendium der Fondation Prix Monique Gabus 2025 (Frankreich). Jiaying He nahm an zahlreichen internationalen Festivals, Akademien und Workshops teil, darunter die Impuls International Ensemble- und Komponistenakademie, die Donaueschinger Musiktage 2023, die Wittener Tage für neue Kammermusik 2025 sowie das NOW!-Festival Essen 2025.",   
    "Neben ihrer kompositorischen Tätigkeit arbeitet Jiaying He auch als Musikjournalistin. Sie schreibt Konzertkritiken und Berichte über Festivals für zeitgenössische Musik und reflektiert darin aktuelle Entwicklungen der Neuen Musik sowie ästhetische und kompositorische Fragestellungen. 2026 nahm sie am Journalistenforum des ECLAT Festivals Neue Musik teil und wird als Journalistin für MusikTexte Online über die Wittener Tage für neue Kammermusik 2026 berichten."
],
  fr: [
    "Jiaying He (*1997) est une compositrice chinoise basée en Allemagne. Son esthétique musicale repose sur le décalage temporel et la répétition de matériaux identiques, générant volontairement des perturbations perceptives et des écarts temporels psychologiques. En intégrant des sons du quotidien ainsi que des bruits instrumentaux, elle considère le son comme un vecteur d’expérience, de mémoire et de présence corporelle, et conçoit la musique comme un espace d’écoute active et de relation ouverte vers l’avenir.",
    "Elle poursuit actuellement un Master de composition au Conservatoire de Paris (CNSMDP) dans la classe de Frédéric Durieux, et suit parallèlement un Master en musicologie (théorie) de la musique avec Elisabeth Schmierer, Hanna Fink et Matthias Schlothfeldt à l’Université des Arts de Folkwang. Elle a obtenu sa licence de musique (Bachelor of Music) en composition intégrative à l’Université des Arts de Folkwang, où elle a étudié avec Günter Steinke.",
    "Actuellement, Jiaying He est finaliste pour une nouvelle œuvre orchestrale commandée par l’Orchestre Philharmonique de Radio France, dont la création aura lieu le 1er octobre 2026 à Paris. Ses œuvres ont été interprétées par des ensembles et orchestres tels que le SWR Symphonieorchester, le WDR Sinfonieorchester et les Bergische Symphoniker, et ont été présentées dans plusieurs pays européens.",
    "Elle a reçu plusieurs prix et bourses, notamment la bourse d’artiste du Land de Rhénanie-du-Nord–Westphalie (2021/22), des aides du DAAD (PROMOS), ainsi que la bourse de la Fondation Prix Monique Gabus 2025 (France). Elle a participé à de nombreux festivals, académies et ateliers internationaux, parmi lesquels l’Impuls International Ensemble- und Komponistenakademie, les Donaueschinger Musiktage 2023, les Wittener Tage für neue Kammermusik 2025 ainsi que le NOW! Festival Essen 2025.",
    "Parallèlement à son activité de compositrice, Jiaying He travaille également comme journaliste musicale. Elle écrit des critiques de concerts et des articles sur des festivals de musique contemporaine, dans lesquels elle réfléchit aux développements actuels de la musique contemporaine ainsi qu’aux questions esthétiques et compositionnelles. En 2026, elle a participé au Forum des journalistes du Festival ECLAT de musique nouvelle et écrira sur les Wittener Tage für neue Kammermusik 2026 pour MusikTexte Online."
  ]
};
...
const WORKS_DATA = [
  ...
  { id: 8, title: "Cette porte ne s'ouvre pas", year: 2025, instrumentation: "Trio", category: "Trio", duration: "ca. 8'", pdfUrl: "/files/CatinBlack Ensemble 3.pdf", audioUrl: "https://youtu.be/bucd-gtNWkI?si=1FhZEXaCu7dSTRpI" },
